...
cd /Users/tav/Development/Tavlean/Sqush/codecs/imagequant
...
```sh
# emsdk 2.0.34 via codecs/cpp.Dockerfile
cd /Users/tav/Development/Tavlean/Sqush/codecs/webp
...
**Risks:** Low-to-medium, mostly indirect. (1) **Coupling:** Sqush builds
...
```sh
# emsdk 2.0.34 via codecs/cpp.Dockerfile
cd /Users/tav/Development/Tavlean/Sqush/codecs/avif
...
> STILL stuck on Sqush's exact pin — strong evidence of WASM build friction. Do
...
cd /Users/tav/Development/Tavlean/Sqush/codecs/jxl
...
cd /Users/tav/Development/Tavlean/Sqush/codecs/oxipng
...
4. Functional: optimize PNGs at the levels Sqush exposes, with interlace toggled
...
cd /Users/tav/Development/Tavlean/Sqush/codecs/mozjpeg
rm -rf node_modules
...
cd /Users/tav/Development/Tavlean/Sqush/codecs/resize
