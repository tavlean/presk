...
| Bulk backend foundation              |      66% | Framework-neutral helpers now cover import, MIME sniffing coverage, settings lookup, queueing, per-job size state, summaries, selection context, actions, processing, and URLs.                                                                                                         |
