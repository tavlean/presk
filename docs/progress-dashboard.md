...
| Repo simplification                  |      36% | Dependency/script cleanup, storage centralization, storage failure handling, and shared/service-worker type cleanup have reduced some legacy loose typing and scattered browser APIs. Codec surface, Preact coupling, and custom Rollup complexity still remain. |
