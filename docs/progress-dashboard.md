...
| Bulk backend foundation              |      73% | Framework-neutral helpers now cover import, injected MIME sniffing, settings lookup, queueing, full queue draining, per-job size state, selected export plans, export summaries, selection context, command action state, processing, and URLs.                                                                                     |
