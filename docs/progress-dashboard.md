...
| Repo simplification                  |      47% | Dependency/script cleanup, Node 24 baseline alignment, storage centralization, storage failure handling, result-cache coverage, shared/service-worker type cleanup, static-build utility cleanup, tested single-image display/source/preprocessor/saved-settings/side-state helpers, and removal of maintained app/lib TS suppressions have reduced some legacy loose typing and scattered browser APIs. Codec surface, Preact coupling, and custom Rollup complexity still remain.                                                                                                                                                                                                                                                                               |
