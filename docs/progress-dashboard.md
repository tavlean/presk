...
| Repo simplification                  |      60% | Dependency/script cleanup, Node 24 baseline alignment, storage centralization, storage failure handling, result-cache coverage, shared abort handling, shared/service-worker type cleanup, static-build utility cleanup, tested single-image work planning/work-start scheduling/side encode planning/job derivation/display/render-state/source/preprocessor/saved-settings/saved-settings-availability/saved-settings-actions and feedback/side-copy feedback/initial-side-state/side-state/editor-update/encoder-support helpers, removal of the main editor's deprecated prop-change lifecycle, and removal of maintained app/lib TS suppressions have reduced some legacy loose typing, scattered browser APIs, and old Preact assumptions. Codec surface, Preact coupling, and custom Rollup complexity still remain.                                                                                                                                                                                                                                                   |
| Svelte/SvelteKit migration readiness |      45% | Shared pipeline, single-image work planning/work-start scheduling/side encode decisions/job derivation/source defaults/preprocessor changes/display render selectors/composed render-state/editor update effects/encoder support/saved-settings availability/saved-settings-actions and feedback/side-copy feedback/initial-side-state/side-state helpers, removal of the main editor's deprecated prop-change lifecycle, and bulk logic extraction have started, and the current Svelte 5/SvelteKit migration guidance is documented. UI migration should wait until behavior is better tested.                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
