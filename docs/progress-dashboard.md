...
| Repo simplification                  |      45% | Dependency/script cleanup, Node 24 baseline alignment, storage centralization, storage failure handling, result-cache coverage, shared/service-worker type cleanup, static-build utility cleanup, tested single-image side-state and source/preprocessor helpers, and removal of maintained app/lib TS suppressions have reduced some legacy loose typing and scattered browser APIs. Codec surface, Preact coupling, and custom Rollup complexity still remain.                                                                                                                                                                                                                                                                                                  |
| Svelte/SvelteKit migration readiness |      32% | Shared pipeline, single-image work planning/source defaults/preprocessor changes/side-state/display-state helpers, and bulk logic extraction have started, and the current Svelte 5/SvelteKit migration guidance is documented. UI migration should wait until behavior is better tested.                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
