...
| Repo simplification                  |      38% | Dependency/script cleanup, storage centralization, storage failure handling, result-cache coverage, shared/service-worker type cleanup, and removal of several obsolete TS suppressions have reduced some legacy loose typing and scattered browser APIs. Codec surface, Preact coupling, and custom Rollup complexity still remain.                                                                                                                                                           |
