...
- Current local work: result render state helper
...
- `npm run test:helpers`: passed after extracting result render-state composition.
- `npm run typecheck`: passed after extracting result render-state composition.
