...
| 3 | **Bulk optimization** | [specs/2026-07-02-bulk-phase-2-promotion.md](specs/2026-07-02-bulk-phase-2-promotion.md) | 🟡 Spec ready | **Top product priority (maintainer, 2026-07-02).** Design phase COMPLETE (all questions decided — [bulk-ui-design-options.md](bulk-ui-design-options.md)); engine built + proven headless; lab at `/lab/bulk` is the reference implementation. **The Phase-2 promotion spec is written — execute it next.** Phase 0 engine unit tests landed: Vitest bulk-engine/helper suite ([test-plan.md](test-plan.md) §4). Multi-Format Compare follows bulk ([road-map.md](road-map.md)). |
