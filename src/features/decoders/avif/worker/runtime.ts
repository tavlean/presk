...
type AvifDecoderModuleFactory = EmscriptenWasm.ModuleFactory<AVIFModule>;

export interface AvifDecoderRuntime {
  loadDecoder(): Promise<AvifDecoderModuleFactory>;
}

export function createAvifDecoderRuntime({ loadDecoder }: AvifDecoderRuntime) {
