...
function generateWebpWorkerEntry() {
  return [
    ...
    '    }',
    '    globalThis.__squshEmscriptenMainScriptUrlOrBlob = avifMtScriptUrl;',
    '    const avifEncoderMt = await import(/* @vite-ignore */ avifMtScriptUrl);',
    '    return avifEncoderMt.default;',
    '  },',
    '  async loadSingleThread() {',
    '    globalThis.__squshEmscriptenMainScriptUrlOrBlob = undefined;',
    '    return avifEncoder;',
    '  },',
    '});',
    ...
    '    }',
    '    globalThis.__squshEmscriptenMainScriptUrlOrBlob = jxlMtScriptUrl;',
    ...
    '    }',
    '    globalThis.__squshEmscriptenMainScriptUrlOrBlob = jxlMtSimdScriptUrl;',
